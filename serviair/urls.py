...
urlpatterns = [
    ...
    url(r'^funcionamientos$', ListTipoFuncionamientosView.as_view(), name='list_funcionamientos'),
    # url, lista tipo funcionamientos
    url(r'^funcionamiento/add$', CreateTipoFuncionamiento.as_view(), name='add_funcionamiento'),
    # url, nuevo tipo funcionamiento
    url(r'^funcionamiento/edit/(?P<pk>[0-9]+)$', EditTipoFuncionamiento.as_view(), name='edit_funcionamiento'),
    # url, Edita funcionamiento

    url(r'^productos$', ListProductosView.as_view(), name='list_productos'),  # url, lista productos
    url(r'^producto/detail/(?P<pk>[0-9]+)$', ProductoDetailView.as_view(), name='detail_producto'),
    ...
    url(r'^type_repuesto/edit/(?P<pk>[0-9]+)$', EditTipoRepuesto.as_view(), name='edit_type_repuesto'),
    # url, Edita type repuesto
    ...
    url(r'^servicio/edit/(?P<pk>[0-9]+)$', EditTipoServicioView.as_view(), name='edit_type_servicio'),
    # url, Edita servicio
...
# Producto API URLs
    ...
    url(r'^anwo/$', AnwoListView.as_view(), name='anwo_api'), # url normal basada en clase,
